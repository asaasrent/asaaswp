...
//    }
    ...
    function update_rewrite_rules($rules) {
        ...
        //catch the root url
        $newRules[$lang_prefix . "?$"] = "example-plugin.php?lang=\$matches[1]";
        tp_logger("\t {$lang_prefix} ?$  --->  example-plugin.php?lang=\$matches[1]", 4);
...
// Proxied translation for google translate
    ...
    function check_for_plugin_update($checked_data) {
        ...
        $args = array(
            ...
            'version' => '1.0.6', //$checked_data->checked[$this->transposh_file_location],
        );
