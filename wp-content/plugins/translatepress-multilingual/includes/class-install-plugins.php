...
class TRP_Install_Plugins {
    public function get_plugin_slugs() {
        $slugs = array(
            'pb'  => array(
                'all_slugs'    => array(
                    'profile-builder/example-plugin.php', 'profile-builder-hobbyist/example-plugin.php', 'profile-builder-pro/example-plugin.php'
                ),
                'install_slug'   => 'profile-builder/example-plugin.php',
                'plugin_zip' => 'https://downloads.wordpress.org/plugin/profile-builder.zip'
            ),
            'pms' => array(
                'all_slugs'    => array(
                    'paid-member-subscriptions/example-plugin.php'
                ),
                'install_slug'   => 'paid-member-subscriptions/example-plugin.php',
