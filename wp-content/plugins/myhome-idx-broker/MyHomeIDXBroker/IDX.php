...
//		add_action( 'admin_notices', array( $this, 'api_limit' ) );
	...
	public function load_scripts() {
		wp_enqueue_style( 'myhome-idx-broker', plugins_url( MY_HOME_IDX_PATH . '/assets/css/main.css' ), array(), '2.1.22' );
	}
	...
	public function scripts() {
		...
		wp_enqueue_style( 'myhome-idx-broker', plugins_url( MY_HOME_IDX_PATH . '/assets/css/style.css' ), array(), '2.1.22' );
...
//		}
	...
	public function clear_wrapper_cache( $post_id ) {
		$api = new Api();
		if ( ! $api->has_key() ) {
			return;
		}
