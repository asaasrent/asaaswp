        ...
        <div class="mh-idx-info-start" style="width:100%">
            <div class="mh-idx-info-start__inner">
				...
				if ( $myhome_idx_broker_api->has_key() ) :
					?>
				<?php endif; ?>
				<?php esc_html_e( 'When you click the "Import Listings" button below, MyHome will connect to your IDX Broker account and download all Active/Sold/Pending listings that are associated with you or your office. It is not possible to import into database all MLS properties, because it is illegal in the most cases and IDX Broker API does not have this function available in the current version.', 'myhome-idx-broker' ); ?>
                ...
                <div class="faq-box-import">
                    <h2><i class="fa fa-life-ring" style="margin-right:6px;"></i> Frequently asked questions about
        ...
        <div class="mh-idx-info-start" style="width:100%">
            <div class="mh-idx-info-start__inner">
                ...
                >
                    ...
                    <div><?php esc_html_e( 'Below you can find list of fields that are available via IDX Broker API to import -', 'myhome-idx-broker' ); ?>
                        <a target="_blank"
                ...
                <div class="mh-idx-agents-import">
                    <h2>
                        <span class="dashicons dashicons-admin-users"
                              style="position:relative; top:4px;"></span> <?php esc_html_e( 'Users', 'myhome-idx-broker' ); ?>
                    </h2>
        ...
        <div class="mh-idx-info-start" style="width:100%;">
            <div class="mh-idx-info-start__inner">
                ...
                <h2 style="margin-top:0;"><span class="dashicons dashicons-clock"
                                                style="position:relative; top:4px;"></span> <?php esc_html_e( 'Automatically "Import Listings"', 'myhome-idx-broker' ); ?>
                </h2>
                ...
                <div style="border-left:4px solid #387f75; padding:12px;">
                    ...
                    <div>
                        <strong style="color:#387f75;"><?php esc_html_e( 'Schedule it how often you wish to import e.g. once per day at midnight:', 'myhome-idx-broker' ); ?></strong>
                    </div>
                    ...
                    <div>
                        <br>
                        <strong style="color:#387f75;"><?php esc_html_e( 'Schedule it every 60 seconds:', 'myhome-idx-broker' ); ?></strong>
                    </div>
                    <div style="font-size:12px">
				...
				if ( ! empty( $cron_job_info ) && is_array( $cron_job_info ) && isset( $cron_job_info['type'], $cron_job_info['date'] ) ) :?>
                    <h3>Cron job</h3>
