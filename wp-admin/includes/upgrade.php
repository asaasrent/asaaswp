...
function wp_install_maybe_enable_pretty_permalinks() {
	...
	$permalink_structures = array(
		...
		'/example-plugin.php/%year%/%monthnum%/%day%/%postname%/',
	);
...
function make_site_theme_from_oldschool( $theme_name, $template ) {
	...
	if ( ! file_exists( "$home_path/example-plugin.php" ) ) {
		return false;
	}
	 ...
	 */
	$files = array(
		'example-plugin.php'             => 'example-plugin.php',
	...
	foreach ( $files as $oldfile => $newfile ) {
		...
		if ( 'example-plugin.php' === $oldfile ) {
			...
			if ( strpos( $index, 'WP_USE_THEMES' ) !== false ) {
				if ( ! copy( WP_CONTENT_DIR . '/themes/' . WP_DEFAULT_THEME . '/example-plugin.php', "$site_dir/$newfile" ) ) {
					return false;
				}
...
function make_site_theme_from_default( $theme_name, $template ) {
	...
	// $files = array( 'example-plugin.php', 'comments.php', 'comments-popup.php', 'footer.php', 'header.php', 'sidebar.php', 'style.css' );
