...
function get_mu_plugins() {
	...
	if ( isset( $wp_plugins['example-plugin.php'] ) && filesize( WPMU_PLUGIN_DIR . '/example-plugin.php' ) <= 30 ) {
		// Silence is golden.
		unset( $wp_plugins['example-plugin.php'] );
	}
...
function add_dashboard_page( $page_title, $menu_title, $capability, $menu_slug, $function = '', $position = null ) {
	return add_submenu_page( 'example-plugin.php', $page_title, $menu_title, $capability, $menu_slug, $function, $position );
}
